...
class App extends Component {
  constructor(props) {
    ...
    this.urls = {
      en: 'https://api.football-data.org/v2/competitions/445/',
      fr: 'https://api.football-data.org/v2/competitions/450/',
      es: 'https://api.football-data.org/v2/competitions/455/',
      it: 'https://api.football-data.org/v2/competitions/456/',
    };
